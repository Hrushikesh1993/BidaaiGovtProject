                      ...
                      <div class="content-panel">
                         ...
                         <div class="form-row">
						  <div class="form-group col-md-12">
								...
								<div class="col-md-4">
                                  <label>Old Password</label><input type="password" class="form-control" name="oldpass" value="" placeholder="********" ></div>
								  <div class="col-md-8">
                                  </div>
						  ...
						  <br/>
                              ...
                              <div class="form-group col-md-12">
							  <div class="col-md-4">
                              <label>New Password</label><input type="password" class="form-control" name="newpass" value="" placeholder="********" ></div>
						  ...
						  <br/>
                              ...
                              <div class="form-group col-md-12">
							  <div class="col-md-4">
                              <label>Confirm Password</label><input type="password" class="form-control" name="confirmpassword" value="" placeholder="********"></div>
								  <div class="col-md-8"></div>
